...
class CfnCustomResource(
    ...
    def __init__(
        self, scope: aws_cdk.core.Construct, id: str, *, service_token: str
    ) -> None:
...
class CfnStack(
    ...
    def __init__(
        ...
        *,
        ...
        parameters: typing.Optional[typing.Union[typing.Mapping[str, str], aws_cdk.core.IResolvable]] = None,
...
class CfnStackProps:
    ...
    def parameters(
        self,
    ) -> typing.Optional[typing.Union[typing.Mapping[str, str], aws_cdk.core.IResolvable]]:
        """``AWS::CloudFormation::Stack.Parameters``.
...
class CustomResourceProvider(
    ...
    def from_lambda(
        cls, handler: aws_cdk.aws_lambda.IFunction
