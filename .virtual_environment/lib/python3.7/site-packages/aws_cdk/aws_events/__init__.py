...
class CfnEventBus(
    ...
    def __init__(
        ...
        *,
        name: str,
        event_source_name: typing.Optional[str] = None,
    ) -> None:
    ...
    def event_source_name(self, value: typing.Optional[str]) -> None:
...
class CfnEventBusPolicy(
    ...
    def __init__(
        ...
        *,
        ...
        principal: str,
        statement_id: str,
        condition: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "ConditionProperty"]] = None,
    ...
    @statement_id.setter
    def statement_id(self, value: str) -> None:
    ...
    def condition(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "ConditionProperty"]]:
    ...
    def condition(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "ConditionProperty"]],
    ) -> None:
    ...
    def event_bus_name(self, value: typing.Optional[str]) -> None:
...
class CfnEventBusProps:
    def __init__(
        self, *, name: str, event_source_name: typing.Optional[str] = None
    ) -> None:
...
class CfnRule(
    ...
    class HttpParametersProperty:
        def __init__(
            self,
            *,
            header_parameters: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Mapping[str, str]]] = None,
            path_parameter_values: typing.Optional[typing.List[str]] = None,
            query_string_parameters: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Mapping[str, str]]] = None,
        ) -> None:
            """
        ...
        def header_parameters(
            ...
            """
            return self._values.get("header_parameters")

        @builtins.property
        def path_parameter_values(self) -> typing.Optional[typing.List[str]]:
            ...
            """
            return self._values.get("path_parameter_values")
        ...
        def query_string_parameters(
            ...
            """
            return self._values.get("query_string_parameters")
    ...
    class InputTransformerProperty:
        def __init__(
            ...
            *,
            input_template: str,
            input_paths_map: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Mapping[str, str]]] = None,
        ) -> None:
            """
    ...
    class TargetProperty:
        ...
        def http_parameters(
            ...
            """
            return self._values.get("http_parameters")
...
class EventPattern:
    def __init__(
        self,
        *,
        account: typing.Optional[typing.List[str]] = None,
        detail: typing.Optional[typing.Mapping[str, typing.Any]] = None,
        detail_type: typing.Optional[typing.List[str]] = None,
        id: typing.Optional[typing.List[str]] = None,
        region: typing.Optional[typing.List[str]] = None,
        resources: typing.Optional[typing.List[str]] = None,
        source: typing.Optional[typing.List[str]] = None,
        time: typing.Optional[typing.List[str]] = None,
        version: typing.Optional[typing.List[str]] = None,
    ) -> None:
...
class IRuleTarget(jsii.compat.Protocol):
    ...
    def bind(
        self, rule: "IRule", id: typing.Optional[str] = None
    ) -> "RuleTargetConfig":
...
class Rule(
    ...
    def from_event_rule_arn(
        cls, scope: aws_cdk.core.Construct, id: str, event_rule_arn: str
    ) -> "IRule":
...
class RuleTargetInput(
    metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-events.RuleTargetInput"
):
...
class RuleTargetInputProperties:
    def __init__(
        ...
        *,
        input: typing.Optional[str] = None,
        input_path: typing.Optional[str] = None,
        input_paths_map: typing.Optional[typing.Mapping[str, str]] = None,
...
class Schedule(
    metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-events.Schedule"
):
...
class EventBus(
    ...
    def from_event_bus_arn(
        cls, scope: aws_cdk.core.Construct, id: str, event_bus_arn: str
    ) -> "IEventBus":
