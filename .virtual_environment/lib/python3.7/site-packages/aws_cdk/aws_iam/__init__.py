...
class CfnGroup(
    ...
    def __init__(
        ...
        *,
        ...
        policies: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "PolicyProperty"]]]] = None,
    ) -> None:
    ...
    def policies(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "PolicyProperty"]]]]:
    ...
    def policies(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "PolicyProperty"]]]],
    ) -> None:
...
class CfnUser(
    ...
    def __init__(
        ...
        *,
        groups: typing.Optional[typing.List[str]] = None,
        login_profile: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "LoginProfileProperty"]] = None,
        managed_policy_arns: typing.Optional[typing.List[str]] = None,
        path: typing.Optional[str] = None,
        permissions_boundary: typing.Optional[str] = None,
        policies: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "PolicyProperty"]]]] = None,
    ...
    def login_profile(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "LoginProfileProperty"]]:
    ...
    def login_profile(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "LoginProfileProperty"]],
    ) -> None:
    ...
    class LoginProfileProperty:
        def __init__(
            ...
            *,
            password: str,
            password_reset_required: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]] = None,
        ) -> None:
            """
...
class CompositeDependable(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.CompositeDependable"
):
...
class IPrincipal(IGrantable, jsii.compat.Protocol):
    ...
    def principal_account(self) -> typing.Optional[str]:
...
class IResourceWithPolicy(aws_cdk.core.IResource, jsii.compat.Protocol):
...
class _IResourceWithPolicyProxy(jsii.proxy_for(aws_cdk.core.IResource)):
    """A resource with a resource policy that can be added to."""
...
class ManagedPolicy(
    ...
    def from_managed_policy_arn(
        cls, scope: aws_cdk.core.Construct, id: str, managed_policy_arn: str
    ) -> "IManagedPolicy":
    ...
    def from_managed_policy_name(
        cls, scope: aws_cdk.core.Construct, id: str, managed_policy_name: str
    ) -> "IManagedPolicy":
...
class OpenIdConnectProvider(
    ...
    def from_open_id_connect_provider_arn(
        cls, scope: aws_cdk.core.Construct, id: str, open_id_connect_provider_arn: str
...
class Policy(
    aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.Policy"
):
    ...
    def from_policy_name(
        cls, scope: aws_cdk.core.Construct, id: str, policy_name: str
    ) -> "IPolicy":
...
class PolicyDocument(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.PolicyDocument"
):
    ...
    def validate_for_any_policy(self) -> typing.List[str]:
    ...
    def validate_for_identity_policy(self) -> typing.List[str]:
    ...
    def validate_for_resource_policy(self) -> typing.List[str]:
...
class PolicyStatement(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.PolicyStatement"
):
...
class PrincipalBase(
    metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/aws-iam.PrincipalBase"
):
...
class PrincipalPolicyFragment(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.PrincipalPolicyFragment"
):
...
class PrincipalWithConditions(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.PrincipalWithConditions"
):
...
class UnknownPrincipal(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.UnknownPrincipal"
):
...
class ArnPrincipal(
    PrincipalBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.ArnPrincipal"
):
...
class _IIdentityProxy(
    jsii.proxy_for(IPrincipal), jsii.proxy_for(aws_cdk.core.IResource)
):
    """A construct that represents an IAM principal, such as a user, group or role."""
...
@jsii.implements(IRole)
class Role(
    aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.Role"
):
    """IAM Role.
...
class User(
    aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.User"
):
    ...
    @builtins.classmethod
    def from_user_name(
        cls, scope: aws_cdk.core.Construct, id: str, user_name: str
    ) -> "IUser":
...
class AnyPrincipal(
    ArnPrincipal, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.AnyPrincipal"
):
...
class Anyone(
    AnyPrincipal, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.Anyone"
):
    """A principal representing all identities in all accounts.
...
class Group(
    aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iam.Group"
):
    ...
    @builtins.classmethod
    def from_group_arn(
        cls, scope: aws_cdk.core.Construct, id: str, group_arn: str
    ) -> "IGroup":
