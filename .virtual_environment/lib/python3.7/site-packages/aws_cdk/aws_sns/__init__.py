...
class CfnSubscription(
    ...
    def __init__(
        ...
        *,
        ...
        raw_message_delivery: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]] = None,
    ...
    @endpoint.setter
    def endpoint(self, value: typing.Optional[str]) -> None:
...
class CfnTopic(
    ...
    def __init__(
        ...
        id: str,
        *,
        content_based_deduplication: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]] = None,
        display_name: typing.Optional[str] = None,
        fifo_topic: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]] = None,
        kms_master_key_id: typing.Optional[str] = None,
        subscription: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "SubscriptionProperty"]]]] = None,
    ...
    def subscription(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "SubscriptionProperty"]]]]:
    ...
    def subscription(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "SubscriptionProperty"]]]],
    ) -> None:
    ...
    @topic_name.setter
    def topic_name(self, value: typing.Optional[str]) -> None:
...
class CfnTopicPolicy(
    ...
    @topics.setter
    def topics(self, value: typing.List[str]) -> None:
...
class CfnTopicPolicyProps:
    def __init__(
        self, *, policy_document: typing.Any, topics: typing.List[str]
    ) -> None:
...
class CfnTopicProps:
    ...
    def fifo_topic(
        ...
        :see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-sns-topic.html#cfn-sns-topic-fifotopic
        """
        return self._values.get("fifo_topic")
...
class StringConditions:
    def __init__(
        ...
        *,
        ...
        match_prefixes: typing.Optional[typing.List[str]] = None,
...
class Subscription(
    ...
    def __init__(
        ...
        *,
        ...
        filter_policy: typing.Optional[typing.Mapping[str, "SubscriptionFilter"]] = None,
...
class SubscriptionFilter(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns.SubscriptionFilter"
):
    """A subscription filter for an attribute."""

    def __init__(
        self, conditions: typing.Optional[typing.List[typing.Any]] = None
    ) -> None:
        """
...
class SubscriptionOptions:
    ...
    def filter_policy(
        self,
    ) -> typing.Optional[typing.Mapping[str, "SubscriptionFilter"]]:
        """The filter policy.
...
class TopicPolicy(
    ...
    def __init__(
        self, scope: aws_cdk.core.Construct, id: str, *, topics: typing.List["ITopic"]
    ) -> None:
        """
        :param scope: -
        :param id: -
...
class Topic(TopicBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns.Topic"):
    ...
    @builtins.classmethod
    def from_topic_arn(
        cls, scope: aws_cdk.core.Construct, id: str, topic_arn: str
    ) -> "ITopic":
