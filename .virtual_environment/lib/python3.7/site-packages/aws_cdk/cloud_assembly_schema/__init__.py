...
class AmiContextQuery:
    def __init__(
        ...
        *,
        account: str,
        filters: typing.Mapping[str, typing.List[str]],
        region: str,
...
class ArtifactManifest:
    def __init__(
        ...
        *,
        ...
        metadata: typing.Optional[typing.Mapping[str, typing.List["MetadataEntry"]]] = None,
    ...
    def metadata(
        self,
    ) -> typing.Optional[typing.Mapping[str, typing.List["MetadataEntry"]]]:
        """Associated metadata.
...
class AssemblyManifest:
    def __init__(
        ...
        *,
        version: str,
        artifacts: typing.Optional[typing.Mapping[str, "ArtifactManifest"]] = None,
...
class AssetManifest:
    def __init__(
        ...
        *,
        version: str,
        docker_images: typing.Optional[typing.Mapping[str, "DockerImageAsset"]] = None,
        files: typing.Optional[typing.Mapping[str, "FileAsset"]] = None,
    ) -> None:
...
class AwsDestination:
    def __init__(
        ...
        *,
        assume_role_arn: typing.Optional[str] = None,
        assume_role_external_id: typing.Optional[str] = None,
...
class ContainerImageAssetMetadataEntry:
    def __init__(
        ...
        *,
        ...
        image_name_parameter: typing.Optional[str] = None,
...
class DockerImageAsset:
    def __init__(
        self,
        *,
        destinations: typing.Mapping[str, "DockerImageDestination"],
...
class FileAsset:
    def __init__(
        self,
        *,
        destinations: typing.Mapping[str, "FileDestination"],
        source: "FileSource",
    ) -> None:
        """A file asset.
...
class FileSource:
    def __init__(
        self, *, path: str, packaging: typing.Optional["FileAssetPackaging"] = None
    ) -> None:
...
class HostedZoneContextQuery:
    def __init__(
        ...
        *,
        ...
        domain_name: str,
        region: str,
        private_zone: typing.Optional[bool] = None,
...
class Manifest(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/cloud-assembly-schema.Manifest"
):
    ...
    def save_assembly_manifest(
        cls, manifest: "AssemblyManifest", file_path: str
    ) -> None:
...
class MetadataEntry:
    def __init__(
        ...
        *,
        type: str,
        data: typing.Optional[typing.Union[str, "FileAssetMetadataEntry", "ContainerImageAssetMetadataEntry", typing.List["Tag"]]] = None,
    ...
    def data(
        self,
    ) -> typing.Optional[typing.Union[str, "FileAssetMetadataEntry", "ContainerImageAssetMetadataEntry", typing.List["Tag"]]]:
        """The data.
...
class NestedCloudAssemblyProperties:
    def __init__(
        self, *, directory_name: str, display_name: typing.Optional[str] = None
    ) -> None:
...
class VpcContextQuery:
    def __init__(
        ...
        *,
        ...
        region: str,
        return_asymmetric_subnets: typing.Optional[bool] = None,
        subnet_group_name_tag: typing.Optional[str] = None,
    ) -> None:
