...
class Annotations(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.Annotations"):
    ...
    def of(cls, scope: "IConstruct") -> "Annotations":
    ...
    def add_deprecation(self, api: str, message: str) -> None:
...
class BundlingDockerImage(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.BundlingDockerImage"
):
...
class CfnCodeDeployBlueGreenAdditionalOptions:
    def __init__(
        self, *, termination_wait_time_in_minutes: typing.Optional[jsii.Number] = None
    ) -> None:
...
class CfnCodeDeployBlueGreenApplication:
    ...
    def ecs_attributes(self) -> "CfnCodeDeployBlueGreenEcsAttributes":
        ...
        return self._values.get("ecs_attributes")
...
class CfnCodeDeployBlueGreenApplicationTarget:
    def __init__(self, *, logical_id: str, type: str) -> None:
...
class CfnCodeDeployBlueGreenEcsAttributes:
    def __init__(
        self,
        *,
        task_definitions: typing.List[str],
        task_sets: typing.List[str],
...
class CfnCodeDeployBlueGreenHookProps:
    ...
    def additional_options(
        ...
        """
        return self._values.get("additional_options")
    ...
    def lifecycle_event_hooks(
        ...
        """
        return self._values.get("lifecycle_event_hooks")
    ...
    def traffic_routing_config(self) -> typing.Optional["CfnTrafficRoutingConfig"]:
        ...
        """
        return self._values.get("traffic_routing_config")
...
class CfnCodeDeployBlueGreenLifecycleEventHooks:
    def __init__(
        self,
        *,
        after_allow_test_traffic: typing.Optional[str] = None,
        after_allow_traffic: typing.Optional[str] = None,
        after_install: typing.Optional[str] = None,
        before_allow_traffic: typing.Optional[str] = None,
        before_install: typing.Optional[str] = None,
    ) -> None:
    ...
    @builtins.property
    def after_allow_test_traffic(self) -> typing.Optional[str]:
        """Function to use to run tasks after the test listener serves traffic to the replacement task set.

        default
        :default: - none
        """
        return self._values.get("after_allow_test_traffic")

    @builtins.property
    def after_allow_traffic(self) -> typing.Optional[str]:
        """Function to use to run tasks after the second target group serves traffic to the replacement task set.

        default
        :default: - none
        """
        return self._values.get("after_allow_traffic")

    @builtins.property
    def after_install(self) -> typing.Optional[str]:
        ...
        :default: - none
        """
        return self._values.get("after_install")

    @builtins.property
    def before_allow_traffic(self) -> typing.Optional[str]:
        ...
        :default: - none
        """
        return self._values.get("before_allow_traffic")

    @builtins.property
    def before_install(self) -> typing.Optional[str]:
        """Function to use to run tasks before the replacement task set is created.

        default
        :default: - none
        """
        return self._values.get("before_install")
...
class CfnMappingProps:
    def __init__(
        self,
        *,
        mapping: typing.Optional[typing.Mapping[str, typing.Mapping[str, typing.Any]]] = None,
    ) -> None:
        """
...
class CfnStackProps:
    def __init__(
        ...
        *,
        ...
        parameters: typing.Optional[typing.Union["IResolvable", typing.Mapping[str, str]]] = None,
...
class CfnTrafficRouting:
    ...
    def prod_traffic_route(self) -> "CfnTrafficRoute":
        ...
        return self._values.get("prod_traffic_route")

    @builtins.property
    def target_groups(self) -> typing.List[str]:
    ...
    def test_traffic_route(self) -> "CfnTrafficRoute":
        """The listener to be used by your load balancer to direct traffic to your target groups."""
        return self._values.get("test_traffic_route")
...
class CfnTrafficRoutingConfig:
    ...
    def time_based_canary(self) -> typing.Optional["CfnTrafficRoutingTimeBasedCanary"]:
        ...
        :default: - none
        """
        return self._values.get("time_based_canary")
    ...
    def time_based_linear(self) -> typing.Optional["CfnTrafficRoutingTimeBasedLinear"]:
        ...
        :default: - none
        """
        return self._values.get("time_based_linear")
...
class CfnTrafficRoutingTimeBasedCanary:
    ...
    def bake_time_mins(self) -> typing.Optional[jsii.Number]:
        ...
        :default: 5
        """
        return self._values.get("bake_time_mins")
    ...
    def step_percentage(self) -> typing.Optional[jsii.Number]:
        ...
        :default: 15
        """
        return self._values.get("step_percentage")
...
class ConstructNode(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.ConstructNode"):
    ...
    @jsii.member(jsii_name="addError")
    def add_error(self, message: str) -> None:
        """DEPRECATED: Adds an { "error":  } metadata entry to this construct.
    ...
    @jsii.member(jsii_name="addInfo")
    def add_info(self, message: str) -> None:
        """DEPRECATED: Adds a { "info":  } metadata entry to this construct.
    ...
    @jsii.member(jsii_name="addWarning")
    def add_warning(self, message: str) -> None:
        """DEPRECATED: Adds a { "warning":  } metadata entry to this construct.
...
class ContextProvider(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.ContextProvider"
):
...
class DefaultStackSynthesizerProps:
    def __init__(
        ...
        *,
        ...
        generate_bootstrap_version_rule: typing.Optional[bool] = None,
    ...
    @builtins.property
    def generate_bootstrap_version_rule(self) -> typing.Optional[bool]:
        ...
        :default: true
        """
        return self._values.get("generate_bootstrap_version_rule")
...
class DependableTrait(
    metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/core.DependableTrait"
):
...
class Expiration(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.Expiration"):
    ...
    @builtins.classmethod
    def from_string(cls, s: str) -> "Expiration":
    ...
    def is_after(self, t: "Duration") -> bool:
    ...
    def is_before(self, t: "Duration") -> bool:
...
class FeatureFlags(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.FeatureFlags"):
    ...
    def is_enabled(self, feature_flag: str) -> typing.Optional[bool]:
...
class _IAssetProxy:
    ...
    __jsii_type__ = "@aws-cdk/core.IAsset"
...
class ILocalBundling(jsii.compat.Protocol):
    """Local bundling.
...
class _ILocalBundlingProxy:
    ...
    __jsii_type__ = "@aws-cdk/core.ILocalBundling"
...
class Reference(
    Intrinsic, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/core.Reference"
):
...
class SecretValue(
    Intrinsic, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.SecretValue"
):
...
class StackSynthesizer(
    metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/core.StackSynthesizer"
):
    ...
    def _emit_stack_artifact(
        ...
        *,
        additional_dependencies: typing.Optional[typing.List[str]] = None,
        assume_role_arn: typing.Optional[str] = None,
        cloud_formation_execution_role_arn: typing.Optional[str] = None,
        parameters: typing.Optional[typing.Mapping[str, str]] = None,
        requires_bootstrap_stack_version: typing.Optional[jsii.Number] = None,
        stack_template_asset_object_url: typing.Optional[str] = None,
    ) -> None:
    ...
    def _synthesize_stack_template(
        self, stack: "Stack", session: "ISynthesisSession"
    ) -> None:
...
class SynthesizeStackArtifactOptions:
    ...
    @builtins.property
    def additional_dependencies(self) -> typing.Optional[typing.List[str]]:
        """Identifiers of additional dependencies.

        default
        :default: - No additional dependencies
        """
        return self._values.get("additional_dependencies")
...
class Token(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.Token"):
    ...
    @builtins.classmethod
    def compare_strings(
        cls, possible_token1: str, possible_token2: str
    ) -> "TokenComparison":
...
class TokenComparison(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.TokenComparison"
):
...
class TokenizedStringFragments(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.TokenizedStringFragments"
):
...
class ValidationResult(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.ValidationResult"
):
...
class ValidationResults(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.ValidationResults"
):
...
class CfnDynamicReference(
    Intrinsic, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.CfnDynamicReference"
):
...
class ConcreteDependable(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.ConcreteDependable"
):
...
class DefaultTokenResolver(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.DefaultTokenResolver"
):
...
class Construct(
    constructs.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.Construct"
):
...
class Resource(
    Construct, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/core.Resource"
):
...
class AssetStaging(
    Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.AssetStaging"
):
...
class CfnElement(
    Construct, metaclass=jsii.JSIIAbstractClass, jsii_type="@aws-cdk/core.CfnElement"
):
...
class CfnHook(CfnElement, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.CfnHook"):
    ...
    def _render_properties(
        self, props: typing.Optional[typing.Mapping[str, typing.Any]] = None
...
class CfnInclude(
    CfnElement, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.CfnInclude"
):
...
class CfnOutput(
    CfnElement, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.CfnOutput"
):
    def __init__(
        self,
        scope: "Construct",
...
class CfnParameter(
    CfnElement, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.CfnParameter"
):
...
class CfnResource(
    CfnRefElement, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.CfnResource"
):
    """Represents a CloudFormation resource."""
...
class CfnRule(
    CfnRefElement, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.CfnRule"
):
...
class CfnStack(
    CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.CfnStack"
):
...
class CfnWaitCondition(
    CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.CfnWaitCondition"
):
...
class CustomResource(
    Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.CustomResource"
):
...
class NestedStack(
    Stack, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.NestedStack"
):
...
class CfnCodeDeployBlueGreenHook(
    ...
    @jsii.member(jsii_name="renderProperties")
    def _render_properties(
        self, _props: typing.Optional[typing.Mapping[str, typing.Any]] = None
    ) -> typing.Optional[typing.Mapping[str, typing.Any]]:
        """
        :param _props: -
        """
    ...
    @applications.setter
    def applications(
        self, value: typing.List["CfnCodeDeployBlueGreenApplication"]
    ) -> None:
    ...
    def additional_options(
        self, value: typing.Optional["CfnCodeDeployBlueGreenAdditionalOptions"]
    ) -> None:
    ...
    def lifecycle_event_hooks(
        self, value: typing.Optional["CfnCodeDeployBlueGreenLifecycleEventHooks"]
    ) -> None:
    ...
    def traffic_routing_config(
        self, value: typing.Optional["CfnTrafficRoutingConfig"]
    ) -> None:
...
class CfnCondition(
    CfnElement, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.CfnCondition"
):
...
class CfnCustomResource(
    CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.CfnCustomResource"
):
...
@jsii.implements(IInspectable)
class CfnMacro(
    CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.CfnMacro"
):
...
class CfnMapping(
    CfnRefElement, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.CfnMapping"
):
