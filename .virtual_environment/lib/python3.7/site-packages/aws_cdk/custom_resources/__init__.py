...
class AwsCustomResourcePolicy(
    ...
    @builtins.classmethod
    def from_statements(
        cls, statements: typing.List[aws_cdk.aws_iam.PolicyStatement]
    ) -> "AwsCustomResourcePolicy":
...
class PhysicalResourceId(
    metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/custom-resources.PhysicalResourceId"
):
