...
class CloudArtifact(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/cx-api.CloudArtifact"):
    ...
    def __init__(
        ...
        *,
        ...
        metadata: typing.Optional[typing.Mapping[str, typing.List[aws_cdk.cloud_assembly_schema.MetadataEntry]]] = None,
...
class CloudAssemblyBuilder(
    ...
    def add_missing(
        ...
        *,
        key: str,
        props: typing.Union[aws_cdk.cloud_assembly_schema.AmiContextQuery, aws_cdk.cloud_assembly_schema.AvailabilityZonesContextQuery, aws_cdk.cloud_assembly_schema.HostedZoneContextQuery, aws_cdk.cloud_assembly_schema.SSMParameterContextQuery, aws_cdk.cloud_assembly_schema.VpcContextQuery, aws_cdk.cloud_assembly_schema.EndpointServiceAvailabilityZonesContextQuery],
...
class MetadataEntry(aws_cdk.cloud_assembly_schema.MetadataEntry):
    def __init__(
        ...
        *,
        type: str,
        data: typing.Optional[typing.Union[str, aws_cdk.cloud_assembly_schema.FileAssetMetadataEntry, aws_cdk.cloud_assembly_schema.ContainerImageAssetMetadataEntry, typing.List[aws_cdk.cloud_assembly_schema.Tag]]] = None,
    ...
    def data(
        self,
    ) -> typing.Optional[typing.Union[str, aws_cdk.cloud_assembly_schema.FileAssetMetadataEntry, aws_cdk.cloud_assembly_schema.ContainerImageAssetMetadataEntry, typing.List[aws_cdk.cloud_assembly_schema.Tag]]]:
        """The data.
