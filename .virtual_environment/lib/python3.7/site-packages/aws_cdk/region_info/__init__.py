...
class Fact(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/region-info.Fact"):
    ...
    @builtins.classmethod
    def register(
        cls, fact: "IFact", allow_replacing: typing.Optional[bool] = None
    ) -> None:
    ...
    @builtins.classmethod
    def unregister(
        cls, region: str, name: str, value: typing.Optional[str] = None
    ) -> None:
...
class FactName(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/region-info.FactName"):
    ...
    def DLC_REPOSITORY_ACCOUNT(cls) -> str:
...
class RegionInfo(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/region-info.RegionInfo"):
    ...
    @builtins.classmethod
    def region_map(cls, fact_name: str) -> typing.Mapping[str, str]:
    ...
    def dlc_repository_account(self) -> typing.Optional[str]:
    ...
    def elbv2_account(self) -> typing.Optional[str]:
