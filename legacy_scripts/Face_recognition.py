...
inverno_image = face_recognition.load_image_file("./datasets/Inverno/inverno.jpg")
inverno_face_encoding = face_recognition.face_encodings(inverno_image)[0]

# Load a second sample picture and learn how to recognize it.
antero_image = face_recognition.load_image_file("./datasets/Antero/antero.JPG")
antero_face_encoding = face_recognition.face_encodings(antero_image)[0]

jose_image = face_recognition.load_image_file("./datasets/Jose/jose.PNG")
jose_face_encoding = face_recognition.face_encodings(jose_image)[0]

guillaume_image = face_recognition.load_image_file("./datasets/Guillaume/guillaume.png")
guillaume_face_encoding = face_recognition.face_encodings(guillaume_image)[0]

pedro_image = face_recognition.load_image_file("./datasets/PeterRam/pedro.png")
